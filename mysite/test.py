...
from login import *
from profile import *
from storeSound import *
from storeSound import storeSound
...
print(isLoginSuccess('a', 'b'))
print(changePassword('a', 'c'))
print(isLoginSuccess('a', 'b'))
print(isLoginSuccess('a', 'c'))
print(changePassword('a', 'b'))
print(isLoginSuccess('a', 'b'))